...
export class DomainesComponent implements OnInit {
  ...
  @Input() availableDomaines: any[] = []; // Domaines from the API (via formations component) that have at least one formation attached to, and thus are proposed to the user
  selectedDomainesIds: string[] = []; // Domaines selected by the user
